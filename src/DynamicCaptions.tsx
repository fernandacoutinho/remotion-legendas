    ...
    >
      ...
      >
        ...
        {processedWords.map((w: Word, idx: number) => {
          ...
          // Ajuste sutil do tamanho da fonte pelo volumePercent ou size
          let fontSize = BASE_FONT_SIZE;
          if (typeof w.volumePercent === "number") {
            const volumeFactor = 0.88 + (clamp(w.volumePercent, 0, 100) / 100) * 0.24;
            fontSize = Math.round(BASE_FONT_SIZE * volumeFactor);
          } else if (typeof w.size === "number") {
            fontSize = w.size;
          }
